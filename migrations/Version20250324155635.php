 ...
 */
final class Version20250324155635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` ADD user_id INT NOT NULL, ADD article_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` DROP user_id, DROP article_id');
    }
}
